...
var PROBLEM_SPEED = 5000;   // Интервал между созданием препятсвиями
var snake = [];             // Змейка
var direction = 'y+';        // Направление движения змейки
var gameIsRunning = false;  // Запущена ли игра
var snake_timer;            // Таймер змейки
var food_timer;             // Таймер еды
var problem_timer;          // Таймер препятсвий
...
var points = document.getElementsByClassName('score-point')[0];     //показатель счета
